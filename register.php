...
$query_str = "SELECT * FROM aaryan_pal_school_user_tbl WHERE user_name='$user_name' && user_password='$password'";
...
if($result -> num_rows == 0) {
  //Insert statement
  $query_stry = "INSERT INTO aaryan_pal_school_user_tbl VALUES (NULL, '$user_name', '$full_name', '$user_email', '$password', '$role')";
  //Execute the query
