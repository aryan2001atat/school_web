...
require_once('includes/school_database.php');
...
//update statement
$query_str = "UPDATE aaryan_pal_school_user_tbl SET
    user_name='$user_name',
...
<?php
    ...
    $query = "SELECT * FROM aaryan_pal_school_user_tbl WHERE user_name='$user_name' AND user_password='$password'";
...
include ('includes/school_footer.php');
?>